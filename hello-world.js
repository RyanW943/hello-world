...
(function () {
    ...
    var new_column1 = "<p>Hello,</p>"; // End with a semicolon, just like CSS
    var new_column2 = "<p>World!</p>";
    var old_column1 = ""; // Empty string, there's space but nothing in it.
    var old_column2 = "";
    ...
    // "click" event listener with anonymous function (WHAT!?!?)
    function theToggler() {
    ...
    document.body.addEventListener("click", theToggler);
}());